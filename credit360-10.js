...
function getReferrer() {
  setTimeout(function() {
	var queryString = (window.location.search || window.parent.location.search);
    var urlParams = new URLSearchParams(queryString);
    var metafel = urlParams.get('metafel');

    // Replace 111111111 with your actual target field ID
    loader.engine.document.getElementById(108685524).setValue({ "value": metafel });
  }, 1000);
}

// Single trigger that fires both functions when a click occurs
