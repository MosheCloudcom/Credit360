function changeButton() {
  ...
  for (var i = 0; i < buttons.length; i++) {
	...
	var FollowingbuttondataRole = buttons[i+1].getAttribute("data-role");;
    ...
    } else if (datatext === "textdef_68" || datatext === "textdef_132") { // Next or Submit button - change to Previous BUT do not change first page
