function changeButton() {
  ...
  for (var i = 0; i < buttons.length; i++) {
	...
	if (i != SubmitButtonIndex && i != LastPreviousButtonIndex) {
	...
	buttons[SubmitButtonIndex].textContent = "Last Previous";
	buttons[SubmitButtonIndex].setAttribute("data-role", "previous-page");
	buttons[LastPreviousButtonIndex].textContent = "Submit 1";
	buttons[LastPreviousButtonIndex].setAttribute("data-role", "submit");
